...
for intent in intents['intents']:
    ...
    for pattern in intent['patterns']:
        ...
        # Correct spelling in pattern (for training, not needed, but for demo)
...
# Example usage for spell correction in prediction (add to your chatbot response function):
